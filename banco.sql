...
create table cli_ex(id int primary key auto_increment, cliente_id int not null, atendente_matricu int not null, id_exame int not null, resultado varchar(100) default null,  foreign key(id_exame) references exame(id));
